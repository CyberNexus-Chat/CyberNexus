...
const translations = {
    'zh-CN': {
        ...
        f8: '🌃 **赛博朋克黑客 UI** — 炫酷的霓虹绿终端美学，让编程充满未来感',
        screenshots: '🖼️ 截图',
    ...
    'zh-TW': {
        ...
        f8: '🌃 **賽博龐克駭客 UI** — 炫酷的霓虹綠終端美學，讓程式設計充滿未來感',
        screenshots: '🖼️ 截圖',
    ...
    'ja': {
        ...
        f8: '🌃 **サイバーパンクハッカーUI** — ネオングリーンのターミナル美学で近未来的コーディング体験',
    ...
    'ko': {
        ...
        f8: '🌃 **사이버펑크 해커 UI** — 네온 그린 터미널 미학으로 미래지향적 코딩 경험',
        screenshots: '🖼️ 스크린샷',
    ...
    'es': {
        ...
        f8: '🌃 **UI Hacker Cyberpunk** — Estética de terminal neón verde que hace que programar se sienta futurista',
    ...
    'fr': {
        ...
        f8: '🌃 **UI Hacker Cyberpunk** — Esthétique terminale néon vert qui rend le développement futuriste',
    ...
    'de': {
        ...
        f8: '🌃 **Cyberpunk-Hacker-UI** — Atemberaubende neongrüne Terminal-Ästhetik für futuristisches Programmieren',
    ...
    'pt': {
        ...
        f8: '🌃 **UI Hacker Cyberpunk** — Estética de terminal neon verde que faz programar parecer futurista',
    ...
    'ru': {
        ...
        f8: '🌃 **Киберпанк Хакер UI** — Потрясающая неоново-зелёная эстетика терминала для футуристического кодинга',
