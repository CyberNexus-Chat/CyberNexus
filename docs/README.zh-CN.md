...
<p align="center">
  ...
  <sub>WhichClaw 是一款桌面应用，为你�?AI 编程工具提供</sub>
</p>
...
<p align="center">
  <a href="../README.md">English</a> · **简体中�?* · <a href="./README.zh-TW.md">繁體中文</a> · <a href="./README.ja.md">日本�?/a> · <a href="./README.ko.md">한국�?/a> · <a href="./README.es.md">Español</a> · <a href="./README.fr.md">Français</a> · <a href="./README.de.md">Deutsch</a> · <a href="./README.pt.md">Português</a> · <a href="./README.ru.md">Русский</a> · <a href="./README.ar.md">العربية</a>
</p>
...
WhichClaw 是一款桌面应用，为你�?AI 编程工具提供**可视化、统一的模型管理界�?*。无需再手动翻配置文件 —�?点一下，就能切换�?
### 痛点
...
- 🍎 **macOS 测试** �?我们还没有完全测�?macOS 构建
- 🔧 **新工具集�?* �?帮助我们支持更多 AI 编程工具
- 🌐 **翻译改进** �?欢迎母语使用者！
...
如果 WhichClaw 对你有帮助，请在 GitHub 上给�?�?—�?让更多人发现这个项目�?
## 📄 许可�?
[MIT](../LICENSE)
